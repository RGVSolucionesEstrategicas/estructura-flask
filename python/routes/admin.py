...
def catalogos():
    ...
    return render_template(
        "main/catalogos.html",
        **data,
        form_clave_oracle=form_clave_oracle,
        table_claves_oracle=table_claves_oracle,
        form_contratos=form_contratos,
        table_contratos=table_contratos,
        form_proveedores=form_proveedores,
        table_proveedores=table_proveedores,
        form_servicios_medicos=form_servicios_medicos,
        table_servicios_medicos=table_servicios_medicos,
        form_ubicaciones=form_ubicaciones,
        table_ubicaciones=table_ubicaciones,
